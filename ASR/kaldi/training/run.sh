...
#timit=/home/neillu/Downloads/TIMIT_Neil/TIMIT # Phone
#timit=/home/neillu/Downloads/TIMIT_5Broad/ # Broad Manner
timit=/home/neillu/Downloads/TIMIT_Broad_Place/ # Broad Place
...
if [ $TYPE == "mono" ]; then
  ...
  echo ============================================================================
  echo "              mono2 :( LDA + MLLT )+ SAT Training & Decoding                 "
  echo ============================================================================

  steps/align_si.sh --boost-silence 1.25 --nj "$train_nj" --cmd "$train_cmd" \
  data/train data/lang exp/mono exp/mono_ali

  # # From mono system, train mono2 which + SAT.
  # steps/train_sat.sh --cmd "$train_cmd" \
  # $numLeavesSAT $numGaussSAT data/train data/lang exp/mono_ali exp/mono2

  # utils/mkgraph.sh data/lang_test_bg exp/mono2 exp/mono2/graph

  # steps/decode_fmllr.sh --nj "$decode_nj" --cmd "$decode_cmd" \
  # exp/mono2/graph data/dev exp/mono2/decode_dev

  # steps/decode_fmllr.sh --nj "$decode_nj" --cmd "$decode_cmd" \
  # exp/mono2/graph data/test exp/mono2/decode_test
